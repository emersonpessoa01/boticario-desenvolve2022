...
/*consultando apenas um registro pela chave*/
select * from tbproduto where produto='1000889';

/*consultando apenas um registro pelo sabor*/
select * from tbproduto where sabor='Uva';
select * from tbproduto where sabor='Limão';

/*alterar sabor limão para cítricos*/
update tbproduto set sabor='Cítricos' where sabor='Limão';
update tbproduto set sabor='Limão' where sabor='Cítricos';

/*consultando produto pelo preço_lista*/
select * from tbproduto;

/*o select não encontra porque preco_lista é um ponto flutuante*/
select * from tbproduto where PRECO_LISTA=16.01;

/*Encontra quando adiciona o sinal de maior invés de igual*/
select * from tbproduto where PRECO_LISTA>16.01;
select * from tbproduto where PRECO_LISTA<16.01;

/*Encontra quando adiciona o sinal de diferente e busca todos*/
select * from tbproduto where PRECO_LISTA<>16.01;

/*busca pelo float através do between*/
select * from tbproduto where PRECO_LISTA between 15.99 and 16.02;

/*consultando apenas um registro pela chave*/
select * from tbcliente where cpf='1471156710';

/*consultando apenas um registro pela cidade*/
select * from tbcliente where cidade='Rio de Janeiro';

/*consultando registro pela idade de 22*/
select * from tbcliente where idade=22;

/*consultando registro pela idade acima de 22*/
select * from tbcliente where idade>22;

/*consultando registro pela idade abaixo de 22*/
select * from tbcliente where idade<22;

/*consultando registro pela idade abaixo ou igual de 22*/
select * from tbcliente where idade<=22;

/*consultando registro pela idade exceto 22*/
select * from tbcliente where idade<>22;

/*consultando registro pelo nome que seja acima da letra inicial do nome em específico*/
